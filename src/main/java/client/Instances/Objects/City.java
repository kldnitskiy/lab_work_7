package client.Instances.Objects;
 ...
 */
public class City implements Comparable<client.Instances.Objects.City>, Serializable {
    /**
    ...
    public static boolean idIsUnique(Long id, PriorityQueue<client.Instances.Objects.City> queue) {
        for (client.Instances.Objects.City city : queue) {
            if (city.getId() == id) {
                return false;
            }
        }
    ...
    @Override
    public int compareTo(client.Instances.Objects.City o) {
        return (int) (this.populationDensity - ((client.Instances.Objects.City) o).populationDensity);
    }
